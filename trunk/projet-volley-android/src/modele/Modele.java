...
public class Modele {
	...
	*/
	...
	private void initMatchTest()
	{
		...
		eqBleu.add(0, new Joueur(1, "Bleu0", 0, 180, 25));
		eqBleu.add(1, new Joueur(2, "Bleu1", 1, 180, 25));
		eqBleu.add(2, new Joueur(3, "Bleu2", 2, 180, 25));
		eqBleu.add(3, new Joueur(4, "Bleu3", 3, 180, 25));
		eqBleu.add(4, new Joueur(5, "Bleu4", 4, 180, 25));
		eqBleu.add(5, new Joueur(6, "Bleu5", 5, 180, 25));
		eqBleu.add(6, new Joueur(7, "Bleu6", 6, 180, 25));
		eqBleu.add(7, new Joueur(8, "Bleu7", 7, 180, 25));
		eqBleu.add(8, new Joueur(9, "Bleu8", 8, 180, 25));
		eqBleu.add(9, new Joueur(10, "Bleu9", 9, 180, 25));
		eqBleu.add(10, new Joueur(11, "Bleu10", 10, 180, 25));
		eqBleu.add(11, new Joueur(12, "Bleu11", 11, 180, 25));
		
		eqRouge.add(0, new Joueur(13, "Rouge0", 0, 180, 25));
		eqRouge.add(1, new Joueur(14, "Rouge1", 1, 180, 25));
		eqRouge.add(2, new Joueur(15, "Rouge2", 2, 180, 25));
		eqRouge.add(3, new Joueur(16, "Rouge3", 3, 180, 25));
		eqRouge.add(4, new Joueur(17, "Rouge4", 4, 180, 25));
		eqRouge.add(5, new Joueur(18, "Rouge5", 5, 180, 25));
		eqRouge.add(6, new Joueur(19, "Rouge6", 6, 180, 25));
		eqRouge.add(7, new Joueur(20, "Rouge7", 7, 180, 25));
		eqRouge.add(8, new Joueur(21, "Rouge8", 8, 180, 25));
		eqRouge.add(9, new Joueur(22, "Rouge9", 9, 180, 25));
		eqRouge.add(10, new Joueur(13, "Rouge10", 10, 180, 25));
		eqRouge.add(11, new Joueur(24, "Rouge11", 11, 180, 25));
